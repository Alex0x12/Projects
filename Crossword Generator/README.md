...
- It is designed to load dictionaries of words and its clues and place it on a grid according to crossword game rules.
...
- Программа загружает словари, состоящие из слов и их значений, и помещает на сетку по правилам игры в кроссворд
